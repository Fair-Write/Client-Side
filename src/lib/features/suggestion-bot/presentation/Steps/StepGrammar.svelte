...
<ScrollArea class="h-[500px]">
	<Card.Root class="my-3 ">
		...
		{:else}
			<Card.Content class="p-5 py-3 flex items-center justify-between">
				<p class="w-[120px] truncate text-sm text-center">
					<span class="font-bold text-red-500">Orginal</span> given there physical strength and cowrage
				</p>
	...
	<!--			<button-->
	<!--				onclick={nextSlide}-->
	<!--				class=" flex items-center justify-center rounded-[9px] border border-solid border-blue-500 hover:border-sky-500 bg-gradient-to-t from-indigo-700 to-blue-300 p-[1px] transition-all ease-in-out hover:from-blue-500 hover:to-sky-200"-->
	<!--			>-->
	<!--				<span-->
	<!--					class="w-full rounded-[8px] bg-gradient-to-t from-indigo-700 to-blue-500 p-2 text-base font-bold text-blue-50 transition-all ease-in-out hover:bg-sky-300 hover:from-blue-500 hover:text-sky-100"-->
	<!--				>-->
